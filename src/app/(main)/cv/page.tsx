        ...
        <div className="col-span-12 lg:col-span-8 lg:col-start-3 min-h-screen py-16">
            ...
            <div className="mb-12">
                ...
                <p className="text-lg text-neutral-600">
                    Biostatistician specializing in causal inference and statistical computing
                </p>
            </div>
                ...
                <Section title="Research Projects">
                    {cv.Projects.map((proj, i) => (
                        <div key={i} className="mb-6 last:mb-0">
                            <h3 className="text-lg font-bold text-primary-900 mb-2">{proj.Title}</h3>
                    ...
                    <div className="grid sm:grid-cols-2 gap-3">
                        {cv.Skills.map((skill, i) => (
                            <div key={i} className="bg-neutral-50 border border-neutral-200 rounded-lg p-3">
                                <h3 className="font-semibold text-primary-900 mb-1 text-sm">{skill.Category}</h3>
                                <p className="text-neutral-700 text-xs leading-relaxed">{skill.Items}</p>
                            </div>
                        ))}
                    </div>
                </Section>
